...
format:
  html:
    ...
    css: styles.css
    toc: true
    toc-title: "Track List"
    code-fold: true
    code-summary: "Show the lyrics behind the magic"
...
## Do Taylor Swift singles have a pattern?

#### Are songs selected to be released as singles more "danceable" or use a faster tempo? I would guess those are key characteristics of single releases.
...
#### Less that 15% or 30 total songs are singles, that's less than I expected.  Let's do a quick check on the differences...
...
My guess that singles being faster or more danceable was incorrect, it appears.  Overall the average tempo rating was lower for singles.  In both cases, nothing to suggest there is a true difference.